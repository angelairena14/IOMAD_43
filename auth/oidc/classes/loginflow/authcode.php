...
class authcode extends base {
    ...
    public function user_login($username, $password = null) {
        ...
        $users = $DB->get_record('user', $userfilters);
	...
	$company_user_filters = ['userid' => $users->id];
	$company_user = $DB->get_record('company_users', $company_user_filters);

	
	if ($company_user == null && $companyid == -1) {
	...
	if ($company_user != null && $companyid !== $company_user->companyid) {
	    return false;
	}
