...
$string['hintro'] = '<img src="{$a->siteurl}/theme/alpha/doc/alpha-icon.png" class="img-fluid rounded my-3" width="80" height="80" alt="Alpha Moodle Theme" /><div class="lead-3">Alpha for Moodle 4.1</div>';
$string['hintro_desc'] = '
